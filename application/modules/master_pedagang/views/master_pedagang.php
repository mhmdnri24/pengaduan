    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Data Pedagang</h3>
                <div class="box-tools pull-right">
                    <?php if (ce_hak_akses('admin.master_pedagang.add')): ?>
                    ...
                    <div class="col-md-4">
                        <div class="info-box bg-aqua">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Total Pedagang</span>
                                <span class="info-box-number"><?= $total_pedagang; ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="info-box bg-green">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Pedagang Aktif</span>
                                <span class="info-box-number"><?= $pedagang_aktif; ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="info-box bg-red">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Pedagang Non-Aktif</span>
                                <span class="info-box-number"><?= $pedagang_nonaktif; ?></span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            <div class="modal-header bg-primary">
                ...
                <h4 class="modal-title" style="color: white;">
                    <i class="fa fa-user"></i> Form Data Pedagang
                </h4>
            </div>
            <form id="form-pedagang" enctype="multipart/form-data">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                ...
                <h4 class="modal-title" style="color: white;">
                    <i class="fa fa-eye"></i> Detail Data Pedagang
                </h4>
            </div>
            <div class="modal-body">
                <div class="row">
