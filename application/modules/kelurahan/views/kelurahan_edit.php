                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            foreach($provinsi as $sel){
                                $selected = $kelurahan->id_provinsi==$sel->id_provinsi ? 'selected' : '';
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <?php 
                            foreach($kota as $sel){
                                $selected = $kelurahan->id_kota==$sel->id_kota ? 'selected' : '';
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <?php 
                            foreach($kecamatan as $sel){
                                $selected = $kelurahan->id_kecamatan==$sel->id_kecamatan ? 'selected' : '';
                                echo '<option value="'.$sel->id_kecamatan.'" '.$selected.'>'.$sel->nama_kecamatan.'</option>';
                            }
                            ?>
                            </select>
                        </div>
